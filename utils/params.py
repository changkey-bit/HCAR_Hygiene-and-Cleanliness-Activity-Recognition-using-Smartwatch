...
STFT_WINDOW_LENGTH_SECONDS_2sec = 2
STFT_HOP_LENGTH_SECONDS_2sec = 0.2
EXAMPLE_WINDOW_SECONDS_2sec = 2   # Each example contains 96 10ms frames
EXAMPLE_HOP_SECONDS_2sec = 0.2   # with zero overlap.
